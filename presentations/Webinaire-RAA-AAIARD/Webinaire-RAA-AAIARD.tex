...
\begin{document}
	...
	\begin{frame}{Objectifs de la présentation}
		\begin{itemize}
			\item Inciter l'intégration des solutions permettant une meilleure reproductibilité dans vos solutions d'affaires.
	...
	\begin{frame}
		...
		\begin{minipage}{0.70\linewidth}
			\begin{itemize}
				...
				\item Membre fondateur de \link{https://baseline.quebec/}{Baseline}
				\item Membre fondateur de \link{https://www.dotlayer.org/}{.Layer}
			\end{itemize}
		\end{minipage}
		...
		\begin{minipage}{0.25\linewidth}
			...
			\footnotesize\email{david.beauchemin@baseline.quebec}{david.beauchemin@baseline.quebec}
		\end{minipage}
	\end{frame}
	...
	\begin{frame}{C'est quoi la reproductibilité ?}
		...
		\note{
			...
			Être capable de \textbf{répliquer} les résultats d'un article ou d'un projet, 
...
%	\end{frame}
	...
	\begin{frame}
		\begin{figure}
			...
			\caption{\link{https://eng.uber.com/scaling-michelangelo/}{From Uber Engineering}}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		\begin{figure}
			...
			\caption{\link{https://johann.schleier-smith.com/blog/2015/08/09/need-for-agile-machine-learning.html}{The need for Agile machine learning}}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Version des données \& Étapes de prétraitement}
		...
		\note{
			...
			Il faut somewhat voir nos données comme des modifications dans un google Doc et qu'à chaque fois qu'on fait du traitement sur nos données c'est comme modifier notre fichier Google Doc et c'est impératif d'avoir une trace, par exemple ...
		}
	...
	\begin{frame}{Version des données \& Étapes de prétraitement}
		\begin{minipage}{0.49\linewidth}
			...
			\vspace{1.25em}
			\link{https://dvc.org/}{Data Version Control}
		\end{minipage}
			\begin{minipage}{0.49\linewidth}
				\centering
				\includesvg[width=30pt, height=30pt]{./img/dask} \vfil
				\vspace{0.75em}
				\link{https://dask.org/}{Dask}
			\end{minipage}
 	\end{frame}
	...
	\begin{frame}{Code}
		\begin{minipage}{0.24\linewidth}
			...
			\vspace{1em}
			\normalsize \link{https://git-scm.com/}{Git}
		\end{minipage}
		\begin{minipage}{0.24\linewidth}
			\centering
			\fontsize{35}{35}\faGithub\vfill
			\vspace{1em}
			\normalsize \link{https://github.com/}{GitHub}
		\end{minipage}
		\begin{minipage}{0.24\linewidth}
			\centering
			\fontsize{35}{35}\faGitlab\vfill
			\vspace{1em}
			\normalsize \link{https://gitlab.com/}{GitLab}
		\end{minipage}
		\begin{minipage}{0.24\linewidth}
			\centering
			\fontsize{35}{35}\faBitbucket\vfill
			\vspace{1em}
			\normalsize \link{https://bitbucket.org/}{Bitbucket}
		\end{minipage}
	\end{frame}
	...
	\begin{frame}{Développement des modèles}
		\begin{minipage}{0.19\linewidth}
			...
			\vspace{1.5em}
			\link{https://poutyne.org/}{Poutyne}
		\end{minipage}
		\begin{minipage}{0.19\linewidth}
			\centering
			\includesvg[width=40pt, height=40pt]{./img/lightning} \vfil
			\vspace{2.75em}
			\link{https://www.pytorchlightning.ai/}{PyTorch Lightning}
		\end{minipage}
		\begin{minipage}{0.19\linewidth}
			\centering
			\includesvg[width=40pt, height=40pt]{./img/scikitlearn} \vfil
			\vspace{2.75em}
			\link{https://scikit-learn.org/stable/}{Scikit-learn}
		\end{minipage}
			\begin{minipage}{0.19\linewidth}
				\centering
				\includesvg[width=40pt, height=40pt]{./img/gensim} \vfil
				\vspace{1em}
				\link{https://radimrehurek.com/gensim/}{Gensim}
			\end{minipage}
			\begin{minipage}{0.19\linewidth}
				\centering
				\includesvg[width=40pt, height=40pt]{./img/AllenNLP} \vfil
				\vspace{3.75em}
				\link{https://github.com/allenai/allennlp}{Allen NLP}
			\end{minipage}
	\end{frame}
	...
	\begin{minipage}{0.24\linewidth}
		...
		\vspace{2em}
		\link{https://hydra.cc/}{Hydra}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\fontsize{35}{35}\faGithub\vfill
		\vspace{1em}
		\normalsize\link{https://sacred.readthedocs.io/en/stable/}{Sacred}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\fontsize{35}{35}\faGithub\vfill
		\vspace{1em}
		\normalsize\link{https://notificationdoc.ca/}{Notif}
	\end{minipage}
\end{frame}
	...
	\begin{frame}{Rapport et analyse des résultats}
		\begin{minipage}{0.19\linewidth}
			...
			\fontsize{35}{35}\faGithub\vfill
			\vspace{3em}
			\normalsize\link{https://github.com/jsleb333/python2latex}{Python2LaTeX}
		\end{minipage}\footnote{\link{https://pythonexamples.org/pandas-render-dataframe-as-html-table/}{Ou en HTML avec Pandas}}
		\begin{minipage}{0.19\linewidth}
			\centering
			\includesvg[width=40pt, height=40pt]{./img/tensorflow} \vfil
			\vspace{1.5em}
			\link{https://www.tensorflow.org/tensorboard?hl=fr}{TensorBoard}
		\end{minipage}
		...
		\end{minipage}\footnote{\link{https://www.youtube.com/watch?v=7jiPeIFXb6U}{\textit{I don't like notebooks} - Joel Grus}}
		\begin{minipage}{0.18\linewidth}
			\centering
			\includesvg[width=40pt, height=40pt]{./img/markdown} \vfil
			\vspace{2.6em}
			\link{https://fr.wikipedia.org/wiki/Markdown}{Markdown}
		\end{minipage}
		\begin{minipage}{0.18\linewidth}
			\centering
			\includesvg[width=40pt, height=40pt]{./img/dash} \vfil
			\vspace{3.5em}
			\link{https://dash.plotly.com/}{Dash}
		\end{minipage}\footnote{\link{https://dash-gallery.plotly.host/dash-oil-and-gas/}{\textit{New York Oil and Gas}}}
	\end{frame}
	...
	\begin{frame}{Environnement}
			...
			\begin{minipage}{0.49\linewidth}
				...
				\vspace{1em}
				\link{https://kubernetes.io/fr/}{Kubernetes}
			\end{minipage}
		\end{frame}
	...
	\begin{frame}{Pour aller plus loin (en ordre)}
		\begin{itemize}
			\item \link{https://www.oreilly.com/library/view/clean-code-a/9780136083238/}{Clean code}
			\item \link{https://github.com/iterative/cml}{Continuous Machine Learning}
			\item \link{https://determined.ai/blog/reproducibility-in-ml/}{Reproducibility in ML: Why it Matters and How to Achieve it}
			...
			\item \link{https://sebastianraschka.com/blog/2018/model-evaluation-selection-part4.html}{Model Evaluation, Model Selection, and Algorithm Selection in Machine Learning}
			\item \link{https://www.youtube.com/watch?v=t86v3N4OshQ&list=LLFp5G_2HoipBrGaw9iAcPPw&index=693}{SOLID}
		\end{itemize}
	\end{frame}
